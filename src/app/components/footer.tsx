        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-gray-600">
          ...
          <div>
            ...
            <ul className="mt-2 space-y-2">
              <li>
                <a onClick={() => alert("⚠️ This content is coming soon :)")} className="hover:text-gray-800">
                  Projects
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="flex mt-2 space-x-4">
              <a href="https://github.com/orgs/lmu-devs/repositories" target="_blank" className="text-gray-600 hover:text-gray-800">
                <svg
                  fill="currentColor"
                  strokeLinecap="round"
              ...
              <a onClick={() => alert("⚠️ This content is coming soon :)")} className="text-gray-600 hover:text-gray-800">
                <svg
                  fill="currentColor"
                  viewBox="0 0 24 24"
                  className="w-6 h-6"
