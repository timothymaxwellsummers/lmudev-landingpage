        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
              LMU <i className="text-4xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-green-500 to-green-600 pr-2 sm:text-6xl">Developers</i>
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600">
            Building Apps for and with the LMU Community. Goal: Build a great team, create awesome projects, and grow together.
            </p>
